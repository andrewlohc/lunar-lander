...
class DQN:
    ...
    def build_model(self):
        model = Sequential()
        model.add(Dense(64, input_dim=self.states, activation="relu", kernel_initializer="RandomUniform"))
...
if __name__ == "__main__":
    ...
    agent = DQN(states=states, actions=actions, exploration_decay=0.999, learning_rate=0.00025)
